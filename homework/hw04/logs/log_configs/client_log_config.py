...
# path_dir_files_logs = 'log_files/clients_logs' # для запуска из самого файла
path_dir_files_logs = 'logs/log_files/clients_logs'
path_file = os.path.join(path_dir, path_dir_files_logs, 'client.log')
...
# хэндлер в файл
file_handler = logging.handlers.TimedRotatingFileHandler(path_file, encoding='utf-8', when='H', interval=1)
