...
class Ui_MainClientWindow(object):
    def setupUi(self, MainClientWindow):
        ...
        self.button_add_contact.setGeometry(QtCore.QRect(10, 450, 121, 31))
        self.button_add_contact.setObjectName("button_add_contact")
        self.button_remove_contact = QtWidgets.QPushButton(self.centralwidget)
        self.button_remove_contact.setGeometry(QtCore.QRect(140, 450, 121, 31))
        ...
        self.button_send.setGeometry(QtCore.QRect(610, 450, 131, 31))
        self.button_send.setObjectName("button_send")
        self.button_clear = QtWidgets.QPushButton(self.centralwidget)
        self.button_clear.setGeometry(QtCore.QRect(460, 450, 131, 31))
    ...
    def retranslateUi(self, MainClientWindow):
        ...
        self.button_add_contact.setText(_translate("MainClientWindow", "Добавить контакт"))
        self.button_remove_contact.setText(_translate("MainClientWindow", "Удалить контакт"))
        ...
        self.button_send.setText(_translate("MainClientWindow", "Отправить сообщение"))
        self.button_clear.setText(_translate("MainClientWindow", "Очистить поле"))
