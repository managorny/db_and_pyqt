...
from common.default_conf import ACTION, PRESENCE, TIME, USER, ACCOUNT_NAME, \
    RESPONSE, ERROR, DEFAULT_IP_ADDRESS, DEFAULT_PORT, MESSAGE, MESSAGE_CLIENT, FROM, TO
...
def load_params():  # TODO try to use argparse
    try:
        # name = 'Demo' # можно использвать для отладки в Pycharm, иначе падает если юзер не в списке подключенных
